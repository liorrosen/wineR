...
For this data the SVMs are a fair bit quicker to train - so let's use those going foward. 
...
If we were using a standard "elbow method" to evaluate the dimensionality of this data - perhaps we'd take 12, 25 or 50 PCs on the basis that adding more gave diminising returns.
