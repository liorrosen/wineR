...
site = read_html(GET("http://www.winemag.com/?s=&drink_type=wine&wine_type=White&pub_date_web=2016&page=1", user_agent(uastring)))
...
for(i in 1:500)
{
  ...
  site = read_html(GET(paste0("http://www.winemag.com/?s=&drink_type=wine&wine_type=White&pub_date_web=2016&page=",i), user_agent(uastring)))
  ...
  saveRDS(Wine_cellar,"Wine_collection_2016WHITE.RDS")
